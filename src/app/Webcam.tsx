// based on https://github.com/mozmorris/react-webcam
...
export type WebcamProps = Omit<JSXInternal.DOMAttributes<HTMLVideoElement>, 'ref'> & {
	audio?: boolean;
...
export default class Webcam extends Component<WebcamProps, WebcamState> {
	//   static defaultProps = {
	// audio: true,
	...
	private requestUserMedia() {
		...
		const sourceSelected = (audioConstraints: boolean | MediaTrackConstraints | undefined, videoConstraints: boolean | MediaTrackConstraints | undefined) => {
